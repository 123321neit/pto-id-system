      ...
      {isFormOpen ? (
        <div className="library-panel">
          <div className="library-panel__intro">
            ...
            <small>
              Добавленный представитель становится частью шаблонных значений и сразу попадает в
              связанные акты. Ручной акт можно отделить позже через режим “ручная версия”.
            </small>
          </div>
