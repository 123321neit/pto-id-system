      ...
      {isFormOpen ? (
        <div className="library-panel">
          <div className="library-panel__intro">
            ...
            <small>
              Выбор не копирует отдельную “организацию объекта”: связанные акты читают текущие
              данные через шаблон, а исторический снимок появится только при ручной версии или
              выпуске.
            </small>
          </div>
